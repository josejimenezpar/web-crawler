...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--min-pages", type=int, default=15, dest="min_pages", metavar="N", help="Páginas mínimas (default: 15)")
    parser.add_argument("--random-pct", type=float, default=10.0, dest="random_pct", metavar="PCT", help="Porcentaje aleatorio (default: 10.0)")
    parser.add_argument("--exclude", nargs="*", metavar="PATTERN", help="Patrones de exclusión")
    parser.add_argument("--delay", type=float, default=1.0, metavar="SEC", help="Delay entre peticiones (default: 1.0)")
    parser.add_argument("--timeout", type=int, default=15000, metavar="MS", help="Timeout por página (default: 15000)")
